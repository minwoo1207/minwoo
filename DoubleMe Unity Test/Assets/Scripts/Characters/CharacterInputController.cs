...
public class CharacterInputController : MonoBehaviour
{
	...
	public bool shieldLife { get { return m_ShieldLife; } set { m_ShieldLife = value; } }
	...
	protected bool m_IsSlidingCombo;
	protected bool m_IsJumpingCombo;
    ...
    protected void Awake ()
    {
        ...
        m_SlideStart = 0.0f;
	    m_IsRunning = false;
		m_IsSlidingCombo = false;
		m_IsJumpingCombo = false;
	...
	protected void Update ()
    {
		...
		if (m_Sliding)
		{
			...
			if (!m_IsSlidingCombo)
			{
				if (Physics.BoxCast(characterCollider.transform.position, characterCollider.transform.lossyScale, Vector3.up,
		...
		if (m_Jumping)
		{
			if (!m_IsJumpingCombo)
			{
				if (Physics.BoxCast(characterCollider.transform.position + Vector3.up, characterCollider.transform.lossyScale, Vector3.down,
